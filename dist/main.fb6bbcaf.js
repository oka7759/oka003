...
var headScroll = document.querySelector('header');
...
var fadeEls = document.querySelectorAll('.wellcome__message .fade-in ');
...
var aboutEls = document.querySelectorAll('.about .inner .about__me .fade-in');
window.addEventListener('scroll', _lodash.default.throttle(function () {
